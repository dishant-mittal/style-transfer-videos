...
-content_pattern bridgevid/bridge_small/small_%04d.png \
-flow_pattern bridgevid/bridge_flow/backward_[%d]_{%d}.flo \
-flowWeight_pattern bridgevid/bridge_flow/reliable_[%d]_{%d}.pgm \
